...
USER_RATE_LIMIT_MAX = int(
    os.environ.get("USER_RATE_LIMIT_MAX", "10")
)  # requests per window
TEAM_RATE_LIMIT_WINDOW = int(os.environ.get("TEAM_RATE_LIMIT_WINDOW", "60"))  # seconds
TEAM_RATE_LIMIT_MAX = int(
    os.environ.get("TEAM_RATE_LIMIT_MAX", "100")
)  # requests per window
...
if RATE_LIMIT_ENABLED:
    logger.info(
        f"Rate limiting enabled: {USER_RATE_LIMIT_MAX} requests per {USER_RATE_LIMIT_WINDOW}s per user, "
